...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("বেবি") || body.startsWith("bot") || body.startsWith("nisan") || body.startsWith("babu") || body.startsWith("বট")) {
            ...
            const randomReplies = ["🦆", "𝙃𝙤𝙥 𝙗𝙚𝙙𝙖🦆, 𝘽𝙤𝙨𝙨 বল 𝙗𝙤𝙨𝙨🦆", "সবার বাবু অনলাইন আছে আমার বাবুটা কই 🦆💨", "বলো সবার,সামনে আজাদ তোমাকে ছাড়া থাকতে পারি না?🦆💨", "—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার বস আজাদ  এর সাথে প্রেম করে তাকে দেখিয়ে দাও-🤗", "আমাকে ডাকলে, আমি কিন্তূ কিস করে দেবো🦆", "𝗯𝗯𝘆 𝗯𝗼𝗹𝘁𝗲 𝗯𝗼𝗹𝘁𝗲 𝗵𝗮𝗽𝗶𝘆𝗲 𝗴𝗲𝘀𝗼 🍷 𝗻𝗲𝘄 𝗮𝗸𝘁𝘂 𝗸𝗵𝗮𝘄🦆"];
            if (!arr) {
